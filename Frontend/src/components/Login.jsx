...
import picturebook from "../assets/picturebook.mp4";
import picturebook_white from "../assets/picturebook_white.png";
  ...
  return (
    <div className="flex justify-start items-center flex-col h-screen">
      ...
      <div className="absolute flex-col flex justify-center items-center top-0 left-0 right-0 bottom-0 bg-blackOverlay">
        ...
        {/* logo */}
        <div className="p-5">
          <img src={picturebook_white} style={{width: "15rem"}} alt="" />
        </div>
